...
function playGif() {
  ...
  // Corrected the typo from 'scr' to 'src'
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  window.controleerAntwoorden = function(buttonId, quizId) {
    ...
    if (quizId === 'quiz1' && antwoord === goedeAntwoorden.quiz1 ||
        quizId === 'quiz2' && antwoord === goedeAntwoorden.quiz2 ||
        quizId === 'quiz3' && antwoord === goedeAntwoorden.quiz3) {
      correctAantal++;
      alert("goed");
      document.getElementById(buttonId).style.display = 'none';
      if (quizId === 'quiz1' || quizId === 'quiz3') {
